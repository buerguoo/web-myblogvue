...
<template>
    ...
    <div v-if="this.$store.state.themeObj.user_start!=0" class="footBack footBackQian">
        ...
        <div class="fcontainer">
            <p>
                博客已正常运行<span v-html='longTime'>{{longTime}}</span><span class="timeJump">(●'◡'●)ﾉ♥</span>
            </p>
			<!--
            <p>
			...
			-->
            <p>
                © 2021 <a href="#">TestWeb</a>. 由 <a href="https://.../" target="_blank">Vue</a> 强力驱动. Theme By <a href="https://.../" target="_blank">diygod.me</a>.
            </p>
			
            <p>
                <span>Made with</span> <img class="fheart" src="static/img/heart02.png"/>  <span>by WHUT.</span>
            </p>
        </div>
    </div>
    <!-- Qinlh的 -->
    <div v-else class="footBack footBackHui">
        ...
        <div class="fcontainer">
            <p>
                本博客已运行<span v-html='longTime'>{{longTime}}</span><span class="timeJump">(●'◡'●)ﾉ♥</span>
            </p>
			<!--
            <p>
			...
			<!--
            <p>
                © 2021 <a href="#">QinlhBlog</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By <a href="https://diygod.me/" target="_blank">diygod.me</a>. 京ICP备17071595号-1.
            </p>
			-->
            <p>
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime:function(){//运行倒计时
                var that = this;
                var oldTime =new Date('2021/08/04 00:00:00');
